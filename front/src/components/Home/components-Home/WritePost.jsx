...
const URI = 'https://jsonplaceholder.typicode.com/users';
 ...
 /*  const navigate = useNavigate() */
  ...
  const store = async (e) => {
      e.preventDefault()
      await axios.post(URI, {text: text, img:img})
  ...
  return (
    <div className="container-filterWritePost">
            ...
            <form className="formWritePost" /* method="post" */ onSubmit={store}>
                ...
                <input type="text" value={text} className="inputWritePost" onChange={ (e)=> setText(e.target.value)} />
                <input type="file" value={img}  accept=".jpg,.png" onChange={ (e)=> setImg(e.target.value)}  />
                ...
                <div className="btnsFormWritePost">
                    ...
                    <button className="btnSendWritePost" type="submit" >
