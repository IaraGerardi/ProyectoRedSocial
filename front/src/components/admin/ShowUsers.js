...
import './admin.css'
import socialLogo from '../pageInitial/assets/Social-dev-opacidad-100.png'
    ...
    <div className='boxAdmin'>
        ...
        <li>Admin</li>
            ...
            <ul key={ user.id} className='boxUser'>
                <li className='idAdminCard name'>ID : {user.id} </li>
                <li className='imgAdminCard'><img className='usersAdmin' src={usersAdmin} alt='user' /></li>
                <li className='name'> Nombre : {user.user} </li>
                <li className='name'> Email : {user.email} </li>
